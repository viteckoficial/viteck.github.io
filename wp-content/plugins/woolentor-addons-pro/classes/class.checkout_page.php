    ...
    */
    public function field_types() {
        $field_type_list = [
            ...
            'checkboxgroup'  => esc_html__( 'Checkbox Ggroup', 'woolentor-pro' ),
        ];
...
if( woolentor_get_option_pro( 'multi_step_checkout', 'woolentor_others_tabs', 'off' ) != 'on' && $woolentor_field_manage_enable === true ){
