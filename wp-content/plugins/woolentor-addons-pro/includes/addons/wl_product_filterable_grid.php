...
class WL_Product_Filterable_Grid_Element extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Product_Filterable_Grid_Element() );