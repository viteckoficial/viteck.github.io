...
class WL_Myaccount_Lostpassword_Form_Element extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Myaccount_Lostpassword_Form_Element() );