            ...
            <a href="<?php the_permalink(); ?>">
                <?php
                    if( 'secondary_img' === $args['image_layout_type'] ){
                        echo $product->get_image( $image_size, array( 'class'=>'ht-default-img' ) );
                        echo $secondary_image;
                    }else{
                        echo $product->get_image( $image_size, array( 'class'=>'ht-default-img ht-product-img-zoom' ) ); 
                    }
                ?>
            </a>
                ...
                <div class="ht-product-action-3">
                    <ul>
                        ...
                        <li class="wlgrid-quickview">
                            <a href="javascript:void(0);" class="ht-product-action-icon-2 woolentorquickview" data-quick-id="<?php the_ID();?>" ><i class="sli sli-magnifier"></i></a>
                        </li>
                    </ul>
                </div>
