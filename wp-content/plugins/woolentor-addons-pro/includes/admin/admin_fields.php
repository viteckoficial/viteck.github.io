                ...
                array(
                    ...
                    'setting_fields' => array(
                        ...
                        array(
                            ...
                            'fields'  => [
                                ...
                                array(
                                    ...
                                    'type'        => 'select',
                                    'options'     => class_exists('WooLentor_Checkout_Page') ? WooLentor_Checkout_Page::instance()->field_types() : [],
                            ...
                            'default' => class_exists('WooLentor_Checkout_Page') && !empty( WooLentor_Checkout_Page::instance()->get_previous_fields('billing') ) ? WooLentor_Checkout_Page::instance()->get_previous_fields('billing') : [
                                [
                        ...
                        array(
                            ...
                            'default' => class_exists('WooLentor_Checkout_Page') && !empty( WooLentor_Checkout_Page::instance()->get_previous_fields('shipping') ) ? WooLentor_Checkout_Page::instance()->get_previous_fields('shipping') : [
                                [
                                    'field_key'             => 'first_name',
                                    'field_label'           => esc_html__( 'First Name', 'woolentor-pro' ),
                                    'field_placeholder'     => '',
                        ...
                        array(
                            ...
                            'default' => class_exists('WooLentor_Checkout_Page') && !empty( WooLentor_Checkout_Page::instance()->get_previous_fields('additional') ) ? WooLentor_Checkout_Page::instance()->get_previous_fields('additional') : [
                                [
