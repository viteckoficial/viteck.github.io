        ...
        <table class="td" cellspacing="0" cellpadding="6" style="border:1px solid #e5e5e5; vertical-align:middle; width: 100%; margin-bottom: 40px; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
            ...
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #e5e5e5;"><?php esc_html_e( 'Payment ID', 'woolentor-pro' ); ?> </th>
                    ...
                    foreach ( $partial_schedule['installment'] as $payment ) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="border: 1px solid #e5e5e5;"><a href="<?php echo esc_url( $payment_order->get_edit_order_url() ); ?>"><?php echo $payment_order->get_id(); ?></a></td>
