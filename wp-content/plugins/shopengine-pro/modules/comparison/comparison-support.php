...
class Comparison_Support {
	...
	public function comparison_bar_on_bottom() {
		...
		if ( $settings == 'yes' && (strpos($_SERVER['REQUEST_URI'], 'comparison') === false)) {
			?>

            <div class="shopengine-comparison-bottom-bar" hidden>
                <div class="shopengine-comparison-button-area" id="shopengine-comparison-button">
                    <a class="comparison-endpoint-bottom" data-comparison-url="<?php echo $url  ?>" hidden>  <i class="eicon-frame-expand"></i> </a>
                    <a class="comparison-bottom-bar-toggle"> <?php echo esc_html__("Compare Products", 'shopengine-pro') ?>  </a>
                </div>
