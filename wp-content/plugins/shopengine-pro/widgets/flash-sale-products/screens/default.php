   ...
   <div class="deal-products-container">
      ...
      <div class="deal-products" data-deal-data='<?php echo json_encode($deal_data) ?>'>
         ...
         <div class="deal-products__top">
            ...
            <?php if($settings['shopengine_show_percentage_badge'] === 'yes' && intval( $product->get_regular_price()) !== 0): ?>
               ...
               <?php else:?>
               <span class="shopengine-offer-badge">-<?php echo apply_filters('flash_sale_fixed_discount_amount', $flash_sale['discount_amount']); ?><?php echo get_woocommerce_currency_symbol();?></span>
               <?php endif;?>
            <?php endif; ?>
