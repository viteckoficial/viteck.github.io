		...
		*/
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-account-order-details table tr :is( td:first-child, th:first-child )' => 'padding-left:{{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .shopengine-account-order-details table tr :is( td:last-child, th:last-child )'   => 'padding-right:{{SIZE}}{{UNIT}};',
				],
			]
		);
