        ...
        <div
            ...
            <div class="shopengine-filter-group-content">
                ...
                <div class="shopengine-product-filters-wrapper"
                     data-filter-price="<?php echo esc_attr($settings['shopengine_filter_toggle_price'], 'shopengine-pro'); ?>"
                     data-filter-rating="<?php echo esc_attr($settings['shopengine_filter_toggle_rating'], 'shopengine-pro'); ?>"
                     data-filter-color="<?php echo esc_attr($settings['shopengine_filter_toggle_color'], 'shopengine-pro'); ?>"
                     data-filter-category="<?php echo esc_attr($settings['shopengine_filter_toggle_category'], 'shopengine-pro'); ?>"
                     data-filter-attribute="<?php echo esc_attr($settings['shopengine_enable_attribute'], 'shopengine-pro'); ?>"
                     data-filter-label="<?php echo esc_attr($settings['shopengine_enable_label'], 'shopengine-pro'); ?>"
                     data-filter-image="<?php echo esc_attr($settings['shopengine_enable_image'], 'shopengine-pro'); ?>"
                     data-filter-shipping="<?php echo esc_attr($settings['shopengine_enable_shipping'], 'shopengine-pro'); ?>"
                     data-filter-stock="<?php echo esc_attr($settings['shopengine_enable_stock'], 'shopengine-pro'); ?>"
                     data-filter-onsale="<?php echo esc_attr($settings['shopengine_enable_onsale'], 'shopengine-pro'); ?>"
                     data-filter-view-mode="<?php echo esc_attr($settings['shopengine_filter_view_mode'], 'shopengine-pro'); ?>"
                >
					<?php
